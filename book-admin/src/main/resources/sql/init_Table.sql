...
CREATE TABLE IF NOT EXISTS `book` (
    ...
    PRIMARY KEY (`id`)
    ) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AVG_ROW_LENGTH=1 ROW_FORMAT=COMPRESSED;

-- 正在导出表  bookshop.book 的数据：~9 rows (大约)
INSERT INTO `book` (`id`, `book_name`, `introduce`, `author`, `creater`, `create_time`, `updater`, `update_time`, `is_delete`) VALUES
                                                                                                                                   ...
                                                                                                                                   (3, '卖包子的小蘑菇', '啦啦啦', 'ffff', '222', '2025-05-08 09:19:18', '', '2025-05-08 09:19:18', '0'),
                                                                                                                                   (7, '天天消消乐', '收到324342342', 'jackfasdfa', 'ddd', '2025-05-08 15:02:15', '', '2025-05-08 15:02:15', '0'),
                                                                                                                                   (8, 'dsfasdfas', 'fsadf', 'dsafs', 'sdaf', '2025-05-08 15:12:11', '', '2025-05-08 15:12:11', '0'),
                                                                                                                                   (9, 'fsdafs', 'dsaf', 'sdaf', 'sfas', '2025-05-08 15:12:18', '', '2025-05-08 15:12:18', '0'),
                                                                                                                                   (10, 'fsadf', 'sfa', 'safa', 'safas', '2025-05-08 15:12:25', '', '2025-05-08 15:12:25', '0'),
                                                                                                                                   (11, 'safas', 'asdf', 'asfda', 'safdas', '2025-05-08 15:12:32', '', '2025-05-08 15:12:32', '0'),
                                                                                                                                   (12, 'safdas', 'afdas', 'sadfa', 'safdas', '2025-05-08 15:12:38', '', '2025-05-08 15:12:38', '0'),
                                                                                                                                   (13, '发生了大宋附加赛', '发大水', '发射点发生', '而我却发撒从', '2025-09-17 09:29:20', '', '2025-09-17 09:29:20', '0');
...
-- 正在导出表  bookshop.permission 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `role` (
    ...
    ) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='角色表，存放角色名称';

-- 正在导出表  bookshop.role 的数据：~1 rows (大约)
...
-- 正在导出表  bookshop.role_permission 的数据：~1 rows (大约)
...
CREATE TABLE IF NOT EXISTS `user` (
                                      `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
                                      `name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '0' COMMENT '用户名',
    `sex` varchar(50) NOT NULL DEFAULT '0' COMMENT '性别',
    `phone` varchar(50) NOT NULL DEFAULT '0' COMMENT '手机号码',
    `birthday` varchar(50) NOT NULL DEFAULT '0' COMMENT '生日',
    `nick_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '昵称',
    `memo` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '备注',
    `creater` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '创建人',
    `create_time` datetime NOT NULL COMMENT '创建时间',
    `updater` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '更新人',
    `update_time` datetime NOT NULL COMMENT '更新时间',
    `is_delete` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '是否删除',
    PRIMARY KEY (`id`) USING BTREE
    ) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci AVG_ROW_LENGTH=1 ROW_FORMAT=COMPRESSED COMMENT='用户表，存储用户基本信息';

-- 正在导出表  bookshop.user 的数据：~1 rows (大约)
INSERT INTO `user` (`id`, `name`, `sex`, `phone`, `birthday`, `nick_name`, `memo`, `creater`, `create_time`, `updater`, `update_time`, `is_delete`) VALUES
    (1, 'jojo', '1', '13820181107', '1999-1-1', '蜗牛', '呜呜呜', 'josey', '2025-04-15 12:26:11', 'josey', '2025-04-15 12:26:18', '0');
...
-- 正在导出表  bookshop.user_role 的数据：~1 rows (大约)
